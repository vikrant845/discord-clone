    ...
    return (
        <div className='flex flex-col h-full text-primary w-full dark:bg-[#2B2D31] bg-[@F2F3F5]'>
            ...
            <ScrollArea className='flex-1 px-3'>
                ...
                {!!textChannels?.length && (
                    <div className="mb-2">
                        <ServerSection label='Text Channels' sectionType="channel" role={ role } channelType={ ChannelType.TEXT } />
                ...
                {!!audioChannels?.length && (
                    <div className="mb-2">
                        <ServerSection label='Audio Channels' sectionType="channel" role={ role } channelType={ ChannelType.AUDIO } />
                        <div className="space-y-[2px]">
                ...
                {!!videoChannels?.length && (
                    <div className="mb-2">
                        <ServerSection label='Video Channels' sectionType="channel" role={ role } channelType={ ChannelType.VIDEO } />
                        <div className="space-y-[2px]">
                ...
                {!!members?.length && (
                    <div className="mb-2">
                        <ServerSection label='Video Channels' sectionType="member" role={ role } />
                        <div className="space-y-[2px]">
                            { members.map(member => (
                                <ServerMember
                                    server={ server! }
